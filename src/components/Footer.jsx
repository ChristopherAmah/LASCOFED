...
const Footer = () => {
  return (
    <footer className="bg-[#101010] text-gray-700 px-6 md:px-10 py-16 border-t border-gray-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr] gap-12">
        {/* Logo & About */}
        <div>
          <img src={logo} alt="LASCOFED Logo" className="h-14 mb-4" />
          <p className="text-[#A4A4A4] text-base leading-relaxed mb-4">
          ...
          <p className="text-white text-sm">©2025 LASCOFED. All rights reserved.</p>
        </div>

        {/* Navigation */}
        <div>
          <h4 className="text-white text-lg font-semibold mb-4">Navigation</h4>
          <ul className="space-y-3 text-[#A4A4A4] text-base">
            <li><a href="#">Home</a></li>
        ...
        <div>
          ...
          <div className="mb-4 space-y-3 text-[#A4A4A4] text-sm">
